...
# class AryuLatestSpider(scrapy.Spider):
#     name = 'aryu_latest'
#     allowed_domains = ['urdu.arynews.tv']
#     start_urls = ['http://urdu.arynews.tv/']
...
class AryLatestSpider(scrapy.Spider):
    name = 'aryu_latest'
    allowed_domains = ['urdu.arynews.tv']
    start_urls = ['https://urdu.arynews.tv/latest-news']
    ...
    def parse_details(self, response):
        ...
        details = response.xpath("//*[self::p/strong or self::p[@ style='text-align: right;']/strong]")
